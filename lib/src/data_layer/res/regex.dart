...
import 'package:keypitkleen_flutter_admin/src/data_layer/res/strings.dart';
...
class AppRegex {
  ...
  static final RegExp firstName = RegExp(r'[A-Za-z]{2,}');
  static final RegExp lastName = RegExp(r'[A-Za-z]{2,}');
  static final RegExp fullName = RegExp(r'[A-Za-z\-\. ]');
  static final RegExp validPhone = RegExp(r'^[6-9]{1}[0-9]{9}$');
...
class FilterFormatter {
  ...
  static final List<TextInputFormatter> addressFilterFormatter = [
  ...
  static final List<TextInputFormatter> firstNameFieldFormatter = [
    FilteringTextInputFormatter.allow(RegExp(r'[a-zA-Z.]')),
    SpaceInputFormatter(),
  ];
