...
class DashboardRepository {
  ...
  Future<BaseApiResponseModel> userManagement(int page) async {
    try {
      BaseApiResponseModel response = await AppNetwork().request(
  ...
  //
  // Future<BaseApiResponseModel> cleanerManagement() async {
  //   try {
  //     BaseApiResponseModel response = await AppNetwork().request(
  //       url: ApiConstants.cleanerManagement,
  //       requestType: HttpRequestMethods.get,
  //     );
  //     LogHelper.logData("DashboardRepository -> cleaner_management ${response.data}");
  //     if (response.data != null) {
  //       _responseBody =
  ...
  //       requestType: HttpRequestMethods.get,
  //     );
  //     LogHelper.logData("DashboardRepository -> payment_management${response.data}");
  //     if (response.data != null) {
  //       _responseBody =
  //           jsonDecode(response.data.toString());
  //       return BaseApiResponseModel(
